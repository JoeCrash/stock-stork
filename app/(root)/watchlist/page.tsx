...
import { getUserAlertsMap } from '@/lib/actions/alerts.actions';
...
const Watchlist = async () => {
    ...
    const alertsMap = await getUserAlertsMap();
    ...
    return (
        <section className="watchlist">
            <div className="flex flex-col gap-6">
                ...
                <WatchlistWithAlerts watchlist={watchlist} initialAlerts={alertsMap} />
            </div>
        </section>
    );
};
